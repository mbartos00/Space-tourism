...
})({"c48y0":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "1293bae57ac04db4";
module.bundle.HMR_BUNDLE_ID = "105c299db3190441";
"use strict";
...
},{}],"iWJdL":[function(require,module,exports) {
...
if (matchMedia('screen and (min-width: 768px)').matches) _gsapDefault.default.set('.main-header--nav', {
    xPercent: 0,
    x: 0
});
else _gsapDefault.default.set('.main-header--nav', {
    xPercent: 150,
    x: 0
});
let hamburgerMotion = _gsapDefault.default.timeline().to('.main-header--nav', {
    xPercent: 0,
    x: 0
}).reverse();
hamburger.addEventListener('click', ()=>{
    if (hamburgerBtn.className.includes('active')) hamburgerBtn.classList.remove('active');
    else hamburgerBtn.classList.add('active');
    hamburgerMotion.reversed(!hamburgerMotion.reversed());
});

},{"gsap":"3ZIKo","@parcel/transformer-js/src/esmodule-helpers.js":"8FsVl"}],"3ZIKo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"3HSju","@parcel/transformer-js/src/esmodule-helpers.js":"8FsVl"}]},["c48y0","iWJdL"], "iWJdL", "parcelRequired02c")
